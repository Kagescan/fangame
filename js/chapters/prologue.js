...
script["chapter00-start"] = [
  ...
  "v Pff... Pourquoi je dois me rendre en <span>classe, pire endroit de l'univers,</span> et de nuit !<br> Et en parlant de ça... ",
  ...
  "v Mais il n'arrêtent pas de faire du bruit pour déranger le cours !",
  ...
  "v M-Me-Me dites pas que c'est un fantôme ou un truc du genre...<br> L-laissez moi tranquille !!!",
  ...
  "??? :<br> Shintaro... -kun ?",
  "shin ... (?)",
  "v J'ai l'impression d'avoir déjà vu ce visage quelque part...",
  ...
  "v Mais que se passe-il ?! Je comprends plus rien !! C'est qui ?!",
...
// choice
  ...
  script["chapter00-ayaNbr"] = [
    ...
    "v Hein ? De quoi parle-elle ?<br>Ah...",
