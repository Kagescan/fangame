...
scriptEn["chapter01-MAO"] = [
  function(){shinOSinstance.exit()},
	...
	"$ _layered ene rh1 smileb lh2 center with fadeIn end-fadeOut",
	"ene There, there, master!",
	"$ _layered ene rh1 smuga lh4 center with fadeIn end-fadeOut",
	...
	"$ _layered ene rh3 laugha lh4 center with fadeIn end-fadeOut",
	"ene Move on already...You know it’s useless.",
	// hier -> remplacer par ce matin, si on a joué au jeu (pas encore fait)
	"$ _layered ene rh3 smileb lh1 center with fadeIn end-fadeOut",
	...
	"$ _layered ene - thinka - center with fadeIn end-fadeOut",
	"ene “The plot is an offense to the original story!”",
	"$ _layered ene - thinkb lh4 center with fadeIn end-fadeOut",
	"ene “The voice actors do not match at all to what I had in mind”",
	"$ _layered ene rh3 laugha - center with fadeIn end-fadeOut",
	"ene And how experienced are <span class='rem'>you</span>, huh, Master?",
	"shin ...",
	"$ _layered ene - thinkb - center with fadeIn end-fadeOut",
