...
scriptFr["chapter00-start"] = [
  ...
  "shin:angry2 <em>Forgetting my wallet in class on the first day of the term, really ?</em>",
  ...
  "shin:facepalm <em>And they really think they’ll go to high school next year? And they’re looking forward to it?<br> I just can’t understand them.</em>",
  ...
  "I’m considering just turning tail and leaving right there, but before I can make a decision the door, suddenly–!</em>",
...
scriptFr["chapter00-ayaContinue"] = [
  ...
  "Let’s just ignore her, get that wallet, and get the hell out of this school.",
  "aya ... ? Um, excuse me...",
	{ Function: {
			Apply: function(){
  ...
  "Ayano steps in front of me, blocking the way into the classroom.",
  ...
  "aya Please… um...I beg you !",
	"The last thing I expected was for a girl to beg me for anything today.",
	"Without thinking, I found myself agreeing.",
...
scriptFr["chapter00-leaveSchool"] = [
  ...
  "shin:blueSight I swear even with my help it took you quite long…",
	"I can’t believe I got dragged into all of this just because I forgot my wallet…",
  "show character aya smile at with fadeIn end-fadeOut",
