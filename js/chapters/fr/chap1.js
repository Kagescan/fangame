...
scriptFr["chapter01-news"] = [
  function(){shinOSinstance.hide()},
	...
	"#2: <br>L'idol n°1 du classement commence sa carrière d'actrice! Elle jouera dans un drama dont la sortie est prévue peu après celle de son nouvel album!",
...
scriptFr["chapter01-eneOrigins"] = [
	...
	"…",
	"Une...fille? Quel est ce programme? <br>Seul ma page de mails semble être ouverte...",
	"…",
	...
	"show character ene old4 with fadeIn end-fadeOut",
	{'Choice':{ 'Dialog': "Peut être qu'elle a une fonction de reconaissance vocale. Je devrais essayer de lui parler.",
	...
	"Il semblerait qu'elle soit endormie en ce moment, ou devrais-je offline? Je ne sais pas.",
...
scriptFr["chapter01-MAO"] = [
  function(){shinOSinstance.exit()},
	...
	"<span class='rem'>Ene…</span>",
	"Cette insolente...cyber-girl? <br>C'est comme ça qu'elle le présente, mais pour être honnête elle est pire qu'un virus informatique.",
	"Bien qu'elle m'appelle “Maître”, ce qui n'est PAS mon idée, elle ne m'apporte que des problèmes depuis un an qu'elle est arrivée.",
	...
	"Mais ne pas pouvvoir utiliser mon ordinateur pendant deux jours, c'est la mort assurée.",
	"Just pour un peu de shopping…",
