...
scriptFr["chapter00-start"] = [
  ...
  "shin:dash <em>Pff... Pourquoi je dois me rendre en <span>classe, pire endroit de l'univers,</span> et de nuit !<br> Et en parlant de ça...</em>",
  ...
  "shin:dash <em>Mais il n'arrêtent pas de faire du bruit pour déranger le cours !</em>",
  "shin:facepalm <em>Dire qu'ils comptent se rendre au lycée l'année prochaine... <br> Pitoyable.</em>",
  "shin:dash <em>C'est pas croyable. Qu'est-ce que je pourrait gagner avec des types pareils ?<br> C'est bien mieux de passer mon temps à feuilleter mes manuels scolaires chez moi.</em>",
...
scriptFr["chapter00-ayaContinue"] = [
  ...
  'show character aya excited with fadeIn end-fadeOut',
  "aya A-Ah !! Sérieux ??!",
  "shin:dash Je te dis que je voulais bien t'aider.",
  "shin:dash Allez, dépêche toi si tu veux commencer !",
  "aya Oui !",
...
scriptFr["chapter00-working"] = [
  ...
  "shin:dash Bref, ne perdons pas de temps ! Reprenons depuis le début !",
...
scriptFr["chapter00-working-endChoice2"] = [
  ...
  "aya:hehe Hihi !",
  "shin:dash Pas la peine de rire autant... T'est vraiment glauque...",
...
scriptFr["chapter00-leaveSchool"] = [
  ...
  "shin:dash Qu'est-ce que tu as ?<br>Tu ne m'avais pas dit que tu oublierai toujours tout ce que tu apprenais ?",
  "show character aya normal at with fadeIn end-fadeOut",
  ...
  "show character aya normal at with fadeIn end-fadeOut",
  "shin:dash Je vois... À plus. J'habite par là donc je tourne ici.",
