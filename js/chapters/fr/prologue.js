...
scriptFr["chapter00-start"] = [
  ...
  "shin:dodge <em>Je devrais penser à autre chose… Aaagh,  Pourquoi vais-je en classe en plus? Je déteste ça!",
  ...
  "shin:normal <em>Ils sont tous prévisibles, ils ne pensent qu'à leur apparence et leur popularité, mais pas vraiment à leurs notes je crois… </em>",
  ...
  "shin:scare4 aAAh !?",
  "shin:scare4 <em>Ce cri du surprise est sorti de ma bouche sans que je puisse le retenir. </em>",
  "shin:scare1 <em>Je venais d'arriver devant ma classe, et je suis sûr d'avoir entendu un bruit bizarre venir de la salle…!</em>",
  ...
  "shin:scare3 <em>Je réfléchis à faire demi tour, mais avant que j'ai eu le temps de prendre une décision, soudain la porte-!</em>",
  "play sound door.ogg",
  ...
  "shin:scare4 <em>Sans y réfléchir j'étais presque à genoux, mes yeux fermés aux paupièrs clouées par la peur… <br>Mais quelques secondes plus tard, je réalisais qu'aucun des esprits de l'école ne m'avait tué… </em>",
  "shin:scare4 <em>Une voix connue m'adressait la parole.</em>",
  "uk Eh ?",
  "uk Shintaro... -kun ?",
...
scriptFr["chapter00-ayaContinue"] = [
  ...
  "aya J'ai eu de plutôt mauvaises notes récemment, alors le professeur m'a donné du travail en plus...",
	"C'est le premier jour du trimestre, non? Comment a t'elle réussi à  déjà avoir du travail supplémentaire…?",
  ...
  "shin:normal Il n'aura donc servi à rien de rester plus tard?",
  'show character aya embarrassed with fadeIn',
  "aya Et bien, c'est vrai, c'était inutile au final..<br>Ah......Comment vais-je faire?",
  ...
  "shin:angry <em>Ignore là, récupère le porte-monnaie, et sors de cette école de tarés.</em>",
  "aya ... ? euh, dis...",
	{ Function: {
			Apply: function(){
  ...
  'show character aya question with fadeIn end-fadeOut',
  "shin:angry2 … Qui t'as permis de regarder ma note?",
  'show character aya shy with fadeIn end-fadeOut',
  ...
  "aya Aah...c'est que.. <br>Pourrais-tu peut-être, euh... m'aider à finir le travail ? Juste un petit peu ?",
  "aya Juste pour aujourd'hui! Ça ne sera pas long!",
  "shin:angry1 … Là maintenant? A cette heure!?",
  'show character aya please with fadeIn end-fadeOut',
  "aya Please… ...Je t'en supplie !",
...
scriptFr["chapter00-working"] = [
  ...
  "show scene classroomDesk with fadeIn",
	"shin:normal <em>La salle est tout de même moins sinistre lumière allumée… Être seulement deux dedans reste bizarre quand même.</em>",
	"shin:normal <em>Ayano me montre le travail, qui est encore sur son bureau.</em>",
  "shin:angry3 … Sérieusement?",
  "shin:normal C'est le théorème de Pytahgore, et tu es incapable de l'utiliser? On l'a appris l'année dernière !",
  ...
  "aya:heh Je ne comprends plus rien… C'est comme si j'avais été projetée dans une utre dimension, quelque chose comme ça! ",
...
scriptFr["chapter00-endWorking"] = [
  ...
  "shin:normal Je ne sais pas si c'est vraiment une chance. Je garde à l'esprit chaque moment aussi insignifiant qu'il soit...",
  ...
  "shin:blush Et bien, non... enfin, si. Ça pourait…",
  "shin:blush Les choses seraient bien plus simples si ça marchait comme ça…",
  "show character aya embarrassed at with fadeIn end-fadeOut",

  "aya Ah! Alors je suis sûre qu'à partir de maintenant, plein de bonnes choses t'arriveront!",
		// OHOHOHO ReAllY ?! xD
...
scriptFr["chapter00-leaveSchool"] = [
  ...
  "shin:dodge Vraiment ?<br> Je croyais t=que tu oubliais tout ce que tu apprenais?",
  "show character aya normal at with fadeIn end-fadeOut",
  "aya Si je fais de mon mieux pour ne pas oublier, ça ira.",
  "shin:normal Hm. Je suis sûre que tu auras une bonne note au prochain test si tu te souviens de ce qu'on a vu.",
